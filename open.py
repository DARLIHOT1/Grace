...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/Grace.git")
			os.system("rm -rf open.py")
			os.system("cp -f DARLIHOT1/open.py \\.")
			os.system("rm -rf open")
